...
class Dog {
	friend class Board;//by making the Board a friend of this class, Dog class is allowing the board class and objects to access all of the dog class' private fields

	string name; //dog name
	int strength;//dogs current strength
	int x;//the x coord of the dogs current position on the board
	int y;//the y coord of the dogs current position on the board
...
public:
	...
	*/
	...
	bool changeStrength(int amount);//change dogs strength
	...
	*/
	...
	void die(); //die message when the strength is at or hits below 0
	...
	*/
	...
	void won();//won message for when dog is at the end of evil forest
